...
public class CalculatorMain {
    ...
    public static void main(String[] args) {
        ...
        try {
            switch (operation) {
                case "1":
                    System.out.println("Végeredmény: " + calculator.add(firstNumber, secondNumber));
                    break;
                case "2":
                    System.out.println("Végeredmény: " + calculator.substract(firstNumber, secondNumber));
                    break;
                case "3":
                    System.out.println("Végeredmény: " + calculator.multiplicate(firstNumber, secondNumber));
                    break;
                case "4":
                    System.out.println("Végeredmény egész része: " + calculator.divide(firstNumber, secondNumber));
                    break;
                default:
